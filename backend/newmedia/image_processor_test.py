...
async def test_JPEGExifDataIsCorrectlyRead():
  ...
  assert info.exif_data == store_schema.ExifData(
      ...
      resolution_unit=2,
      software="GIMP 2.4.5",
      date_time=datetime.datetime.strptime("2008:07:31 10:38:11", "%Y:%m:%d %H:%M:%S"))
...
async def test_TIFFExifDataIsCorrectlyRead():
  ...
  assert info.exif_data == store_schema.ExifData(
      ...
      date_time=datetime.datetime.strptime("2009:09:26 01:11:52", "%Y:%m:%d %H:%M:%S"),
      compression=5,
...
async def test_RawExifDataIsCorrectlyRead():
  ...
  assert info.exif_data == store_schema.ExifData(
      ...
      resolution_unit=2,
      software='Ver.1.00 ',
      date_time=datetime.datetime.strptime('2019:06:10 09:17:13', "%Y:%m:%d %H:%M:%S"),
      exposure_program=1,
      iso_speed_ratings=400,
      date_time_original=datetime.datetime.strptime('2019:06:10 09:17:13', "%Y:%m:%d %H:%M:%S"),
      date_time_digitized=datetime.datetime.strptime('2019:06:10 09:17:13', "%Y:%m:%d %H:%M:%S"),
